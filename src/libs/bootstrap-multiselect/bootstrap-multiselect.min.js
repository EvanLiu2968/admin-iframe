!function(b){function q(a,b){for(var c=0;c<a.length;++c)b(a[c],c)}function k(a,c){this.$select=b(a);this.options=this.mergeOptions(b.extend({},c,this.$select.data()));this.$select.attr("data-placeholder")&&(this.options.nonSelectedText=this.$select.data("placeholder"));this.originalOptions=this.$select.clone()[0].options;this.query="";this.lastToggledInput=this.searchTimeout=null;this.options.multiple="multiple"===this.$select.attr("multiple");this.options.onChange=b.proxy(this.options.onChange,this);
	...
	1)},disposeWhenNodeIsRemoved:a})}if(d.has("value")){var n=d.get("value");ko.isObservable(n)&&ko.computed({read:function(){n();setTimeout(function(){g.multiselect("refresh")},1)},disposeWhenNodeIsRemoved:a}).extend({rateLimit:100,notifyWhenChangesStop:!0})}if(d.has("selectedOptions")){var p=d.get("selectedOptions");ko.isObservable(p)&&ko.computed({read:function(){p();setTimeout(function(){g.multiselect("refresh")},1)},disposeWhenNodeIsRemoved:a}).extend({rateLimit:100,notifyWhenChangesStop:!0})}var l=
	function(a){setTimeout(function(){a?g.multiselect("enable"):g.multiselect("disable")})};if(d.has("enable")){var k=d.get("enable");ko.isObservable(k)?ko.computed({read:function(){l(k())},disposeWhenNodeIsRemoved:a}).extend({rateLimit:100,notifyWhenChangesStop:!0}):l(k)}if(d.has("disable")){var m=d.get("disable");ko.isObservable(m)?ko.computed({read:function(){l(!m())},disposeWhenNodeIsRemoved:a}).extend({rateLimit:100,notifyWhenChangesStop:!0}):l(!m)}ko.utils.domNodeDisposal.addDisposeCallback(a,function(){g.multiselect("destroy")})},
	...
	checkboxName:function(a){return!1},optionLabel:function(a){return b(a).attr("label")||b(a).text()},optionClass:function(a){return b(a).attr("class")||""},onChange:function(a,b){},onDropdownShow:function(a){},onDropdownHide:function(a){},onDropdownShown:function(a){},onDropdownHidden:function(a){},onSelectAll:function(){},onDeselectAll:function(){},onInitialized:function(a,b){},onFiltering:function(a){},enableHTML:!1,buttonClass:"form-control",inheritClass:!1,buttonWidth:"100%",buttonContainer:'<div class="btn-group" />',
	dropRight:!1,dropUp:!1,selectedClass:"active",maxHeight:!1,includeSelectAllOption:!1,includeSelectAllIfMoreThan:0,selectAllText:" \u5168\u9009",selectAllValue:"multiselect-all",selectAllName:!1,selectAllNumber:!0,selectAllJustVisible:!0,enableFiltering:!1,enableCaseInsensitiveFiltering:!1,enableFullValueFiltering:!1,enableClickableOptGroups:!1,enableCollapsibleOptGroups:!1,filterPlaceholder:"Search",filterBehavior:"text",includeFilterClearBtn:!0,preventInputChangeEvent:!1,nonSelectedText:"\u8bf7\u9009\u62e9",
	nSelectedText:"\u5df2\u9009\u62e9",allSelectedText:"\u5df2\u5168\u90e8\u9009\u62e9",numberDisplayed:3,disableIfEmpty:!1,disabledText:"",delimiterText:", ",templates:{button:'<button type="button" class="multiselect dropdown-toggle" data-toggle="dropdown"><span class="multiselect-selected-text"></span> <b class="caret multiselect-caret"></b></button>',ul:'<ul class="multiselect-container dropdown-menu"></ul>',filter:'<li class="multiselect-item multiselect-filter"><div class="input-group"><span class="input-group-addon"><i class="glyphicon glyphicon-search"></i></span><input class="form-control multiselect-search" type="text"></div></li>',
...
"auto"!==this.options.buttonWidth&&(this.$button.css({width:"100%",overflow:"hidden","text-align":"left","white-space":"nowrap","text-overflow":"ellipsis"}),this.$container.css({width:this.options.buttonWidth}));var a=this.$select.attr("tabindex");a&&this.$button.attr("tabindex",a);this.$container.prepend(this.$button)},buildDropdown:function(){this.$ul=b(this.options.templates.ul);this.options.dropRight&&this.$ul.addClass("pull-right");this.options.maxHeight&&this.$ul.css({"max-height":this.options.maxHeight+
"px","overflow-y":"auto","overflow-x":"hidden"});if(this.options.dropUp){var a=Math.min(this.options.maxHeight,26*b('option[data-role!="divider"]',this.$select).length+19*b('option[data-role="divider"]',this.$select).length+(this.options.includeSelectAllOption?26:0)+(this.options.enableFiltering||this.options.enableCaseInsensitiveFiltering?44:0));this.$ul.css({"max-height":a+"px","overflow-y":"auto","overflow-x":"hidden","margin-top":"-"+(a+34)+"px"})}this.$container.append(this.$ul)},buildDropdownOptions:function(){this.$select.children().each(b.proxy(function(a,
  c){a=b(c);var d=a.prop("tagName").toLowerCase();a.prop("value")!==this.options.selectAllValue&&("optgroup"===d?this.createOptgroup(c):"option"===d&&("divider"===a.data("role")?this.createDivider():this.createOptionValue(c)))},this));b("li:not(.multiselect-group) input",this.$ul).on("change",b.proxy(function(a){var c=b(a.target);a=c.prop("checked")||!1;var d=c.val()===this.options.selectAllValue;this.options.selectedClass&&(a?c.closest("li").addClass(this.options.selectedClass):c.closest("li").removeClass(this.options.selectedClass));
...
(d=0);c=c.eq(d);c.focus();if(32===a.keyCode||13===a.keyCode)c=c.find("input"),c.prop("checked",!c.prop("checked")),c.change();a.stopPropagation();a.preventDefault()}}},this));if(this.options.enableClickableOptGroups&&this.options.multiple)b("li.multiselect-group input",this.$ul).on("change",b.proxy(function(a){a.stopPropagation();var c=b(a.target).prop("checked")||!1;a=b(a.target).closest("li");var d=a.nextUntil("li.multiselect-group").not(".multiselect-filter-hidden").not(".disabled").find("input"),
		e=[];this.options.selectedClass&&(c?a.addClass(this.options.selectedClass):a.removeClass(this.options.selectedClass));b.each(d,b.proxy(function(a,d){a=b(d).val();var f=this.getOptionByValue(a);c?(b(d).prop("checked",!0),b(d).closest("li").addClass(this.options.selectedClass),f.prop("selected",!0)):(b(d).prop("checked",!1),b(d).closest("li").removeClass(this.options.selectedClass),f.prop("selected",!1));e.push(this.getOptionByValue(a))},this));this.options.onChange(e,c);this.updateButtonText();this.updateSelectAll()},
...
a&&(this.$filter=b(this.options.templates.filter),b("input",this.$filter).attr("placeholder",this.options.filterPlaceholder),this.options.includeFilterClearBtn&&(a=b(this.options.templates.filterClearBtn),a.on("click",b.proxy(function(a){clearTimeout(this.searchTimeout);this.$filter.find(".multiselect-search").val("");b("li",this.$ul).show().removeClass("multiselect-filter-hidden");this.updateSelectAll();this.options.enableClickableOptGroups&&this.options.multiple&&this.updateOptGroups()},this)),
	this.$filter.find(".input-group").append(a)),this.$ul.prepend(this.$filter),this.$filter.val(this.query).on("click",function(a){a.stopPropagation()}).on("input keydown",b.proxy(function(a){13===a.which&&a.preventDefault();clearTimeout(this.searchTimeout);this.searchTimeout=this.asyncFunction(b.proxy(function(){if(this.query!==a.target.value){this.query=a.target.value;var c,e;b.each(b("li",this.$ul),b.proxy(function(a,d){var f=0<b("input",d).length?b("input",d).val():"",g=b("label",d).text();a="";
	"text"===this.options.filterBehavior?a=g:"value"===this.options.filterBehavior?a=f:"both"===this.options.filterBehavior&&(a=g+"\n"+f);f!==this.options.selectAllValue&&g&&(f=!1,this.options.enableCaseInsensitiveFiltering&&(a=a.toLowerCase(),this.query=this.query.toLowerCase()),this.options.enableFullValueFiltering&&"both"!==this.options.filterBehavior?(a=a.trim().substring(0,this.query.length),-1<this.query.indexOf(a)&&(f=!0)):-1<a.indexOf(this.query)&&(f=!0),b(d).toggle(f).toggleClass("multiselect-filter-hidden",
	...
	refresh:function(){var a=b.map(b("li input",this.$ul),b);b("option",this.$select).each(b.proxy(function(c,d){c=b(d);d=c.val();for(var e,f=a.length;0<f--;)if(d===(e=a[f]).val()){c.is(":selected")?(e.prop("checked",!0),this.options.selectedClass&&e.closest("li").addClass(this.options.selectedClass)):(e.prop("checked",!1),this.options.selectedClass&&e.closest("li").removeClass(this.options.selectedClass));c.is(":disabled")?e.attr("disabled","disabled").prop("disabled",!0).closest("li").addClass("disabled"):
		...
		e=b("li:not(.divider):not(.disabled):not(.multiselect-group):not(.multiselect-filter-hidden):not(.multiselect-collapisble-hidden)",this.$ul).filter(":visible");a?(b("input:enabled",e).prop("checked",!0),e.addClass(this.options.selectedClass),b("input:enabled",e).each(b.proxy(function(a,c){a=b(c).val();a=this.getOptionByValue(a);b(a).prop("selected",!0)},this))):(b("input:enabled",d).prop("checked",!0),d.addClass(this.options.selectedClass),b("input:enabled",d).each(b.proxy(function(a,c){a=b(c).val();
		a=this.getOptionByValue(a);b(a).prop("selected",!0)},this)));b('li input[value="'+this.options.selectAllValue+'"]',this.$ul).prop("checked",!0);this.options.enableClickableOptGroups&&this.options.multiple&&this.updateOptGroups();if(c)this.options.onSelectAll()},deselectAll:function(a,c){a="undefined"===typeof a?!0:a;var d=b("li:not(.divider):not(.disabled):not(.multiselect-group)",this.$ul),e=b("li:not(.divider):not(.disabled):not(.multiselect-group):not(.multiselect-filter-hidden):not(.multiselect-collapisble-hidden)",
		this.$ul).filter(":visible");a?(b('input[type="checkbox"]:enabled',e).prop("checked",!1),e.removeClass(this.options.selectedClass),b('input[type="checkbox"]:enabled',e).each(b.proxy(function(a,c){a=b(c).val();a=this.getOptionByValue(a);b(a).prop("selected",!1)},this))):(b('input[type="checkbox"]:enabled',d).prop("checked",!1),d.removeClass(this.options.selectedClass),b('input[type="checkbox"]:enabled',d).each(b.proxy(function(a,c){a=b(c).val();a=this.getOptionByValue(a);b(a).prop("selected",!1)},
		this)));b('li input[value="'+this.options.selectAllValue+'"]',this.$ul).prop("checked",!1);this.options.enableClickableOptGroups&&this.options.multiple&&this.updateOptGroups();if(c)this.options.onDeselectAll()},rebuild:function(){this.$ul.html("");this.options.multiple="multiple"===this.$select.attr("multiple");this.buildSelectAll();this.buildDropdownOptions();this.buildFilter();this.updateButtonText();this.updateSelectAll(!0);this.options.enableClickableOptGroups&&this.options.multiple&&this.updateOptGroups();
		this.options.disableIfEmpty&&0>=b("option",this.$select).length?this.disable():this.enable();this.options.dropRight&&this.$ul.addClass("pull-right")},dataprovider:function(a){var c=0,d=this.$select.empty();b.each(a,function(a,f){var e;if(b.isArray(f.children))c++,e=b("<optgroup/>").attr({label:f.label||"Group "+c,disabled:!!f.disabled}),q(f.children,function(a){var c={value:a.value,label:a.label||a.value,title:a.title,selected:!!a.selected,disabled:!!a.disabled},d;for(d in a.attributes)c["data-"+
	d]=a.attributes[d];e.append(b("<option/>").attr(c))});else{a={value:f.value,label:f.label||f.value,title:f.title,"class":f.class,selected:!!f.selected,disabled:!!f.disabled};for(var h in f.attributes)a["data-"+h]=f.attributes[h];e=b("<option/>").attr(a);e.text(f.label||f.value)}d.append(e)});this.rebuild()},enable:function(){this.$select.prop("disabled",!1);this.$button.prop("disabled",!1).removeClass("disabled")},disable:function(){this.$select.prop("disabled",!0);this.$button.prop("disabled",!0).addClass("disabled")},
	setOptions:function(a){this.options=this.mergeOptions(a)},mergeOptions:function(a){return b.extend(!0,{},this.defaults,this.options,a)},hasSelectAll:function(){return 0<b("li.multiselect-all",this.$ul).length},updateOptGroups:function(){var a=b("li.multiselect-group",this.$ul),c=this.options.selectedClass;a.each(function(){var a=!0;b(this).nextUntil("li.multiselect-group").not(".multiselect-filter-hidden").not(".disabled").each(function(){b("input",this).prop("checked")||(a=!1)});c&&(a?b(this).addClass(c):
		...
		this.getSelected();this.options.enableHTML?b(".multiselect .multiselect-selected-text",this.$container).html(this.options.buttonText(a,this.$select)):b(".multiselect .multiselect-selected-text",this.$container).text(this.options.buttonText(a,this.$select));b(".multiselect",this.$container).attr("title",this.options.buttonTitle(a,this.$select))},getSelected:function(){return b("option",this.$select).filter(":selected")},getOptionByValue:function(a){var c=b("option",this.$select);a=a.toString();for(var d=
