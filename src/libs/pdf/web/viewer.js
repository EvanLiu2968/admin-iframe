 ...
 */
var pdfViewerInit=function(initConfig){
//�˴�����������
	...
	([
		...
		/***/ (function(module, exports, __webpack_require__) {
			...
			function configure(PDFJS) {
				PDFJS.imagesrcPath = initConfig.imagesrcPath || './images/';
				PDFJS.workerSrc = initConfig.workerSrc || '../build/pdf.worker.js';
				PDFJS.cMapUrl = initConfig.cMapUrl || '../web/cmaps/';
				PDFJS.cMapPacked = initConfig.cMapPacked || true;
				PDFJS.locale = initConfig.locale || "zh-CN";
			}
		...
		/***/ (function(module, exports, __webpack_require__) {
			...
			var DEFAULT_URL = initConfig.pdfFileSrc||'compressed.tracemonkey-pldi-09.pdf';
